            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                    ...
                    child: Stack(
                      children: [
                        SizedBox(
                          width: 70.w,
                          height: 70.h,
                          child: Image.network(food.imageUrl[0],fit: BoxFit.cover,),
                        ),
                        Positioned(
                          bottom: 0,
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ReusableText(style: appStyle(11, kDark, FontWeight.w400), text: food.title),
                        ...
                        itemBuilder: (context,i){
                          ...
                          return Container(
                            ...
                            child: Center(
                              ...
                              child: ReusableText(style: appStyle(8, kGray, FontWeight.w400), text: additive.title),
